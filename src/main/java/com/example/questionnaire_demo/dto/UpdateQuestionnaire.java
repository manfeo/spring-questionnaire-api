...
@AllArgsConstructor
@NoArgsConstructor
@Schema(description = "Данные для обновления существующей анкеты")
public class UpdateQuestionnaire {
    @Schema(description = "Категории работ", example = "Строительство домов, Ремонт квартир")
    ...
    @Schema(description = "Информация о команде (состав, роли, задачи)", example = "Своя бригада из 5 человек")
    private String team;
    ...
    @Schema(description = "Информация о себе (био, навыки, о проекте)", example = "В строительстве уже более 10 лет. Делаю качественно.")
